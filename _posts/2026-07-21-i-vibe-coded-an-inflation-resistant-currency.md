...
In 2017 I quit my job to pursue a career in cryptocurrency. I had high hopes. Nearly a decade later, crypto is still barely functional for the thing it was supposedly invented to do: paying people.

Last summer a friend helped me rebuild my failing dock. It took an entire afternoon just to get him set up with a Bitcoin wallet so I could send him some Bitcoin for his trouble. This summer, he has half as much "money" in that wallet as when I sent it.

That experience crystallized something for me. For the ideals of crypto to ever come to fruition, it needs to pass what I call the **"send me five bucks test"**: if you have an iPhone, I should be able to send you five bucks without you downloading or installing anything. The transaction should settle in under a couple of seconds and cost a penny or two in fees, at most.

I vibe coded [bitcoin.dance](https://bitcoin.dance) to prove this is possible.

## What money actually does

Economists say currency has three functions: it's a unit of account, a store of value, and a medium of exchange. Here's how bitcoin.dance handles each one.

### Unit of account

The unit of account in bitcoin.dance is pegged to the US dollar — but every account continuously accrues interest. This simply wasn't possible before cryptocurrency. If you have $100 in your pocket, there's no mechanism by which it becomes $100.01 by tomorrow. In bitcoin.dance, there is.
...
bitcoin.dance settles transactions on Base, a modern, low-cost blockchain. That's what makes the "send me five bucks test" passable: transfers confirm in seconds and cost fractions of a cent, instead of the slow, expensive settlement that made my dock-payment afternoon such an ordeal.
...
When the dollar left the gold standard, it didn't lose 100% of its value (yet). People keep trading dollars because they know other people will accept them for goods and services. The trust just moved from the vault to the network of people willing to take the paper.

## Unbundling money

Technology has a habit of bundling and unbundling goods and services. When TV and radio were the only ways to consume content, nearly everyone got the same bundle. As the internet grew, content unbundled — you chose which blogs and sites to read, piece by piece.
...
bitcoin.dance is my own remix of that bundle: dollars as the unit of account, an interest-bearing Morpho vault as the store of value, and a fast, cheap blockchain as the medium of exchange — wrapped in an experience simple enough to pass the five bucks test.
